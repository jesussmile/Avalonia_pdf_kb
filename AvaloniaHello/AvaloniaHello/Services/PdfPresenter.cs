...
public static class PdfPresenter
{
    ...
    private static readonly Lazy<IPdfPresenter> DefaultPresenterFactory = new(() =>
    {
        if (OperatingSystem.IsAndroid() || OperatingSystem.IsIOS())
        {
            return new LauncherOnlyPdfPresenter(PdfLauncher.Current);
        }

        return new DesktopPdfPresenter();
    });
    ...
    public static IPdfPresenter Current => _platformPresenter ?? DefaultPresenterFactory.Value;
}

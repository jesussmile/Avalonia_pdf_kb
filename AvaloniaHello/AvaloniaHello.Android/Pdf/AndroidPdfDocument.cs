...
internal sealed class AndroidPdfDocument : IDisposable
{
    ...
    {
        var renderer = _renderer ?? throw new InvalidOperationException("PDF renderer not initialized");
        ...
        using var page = renderer.OpenPage(targetIndex) ?? throw new InvalidOperationException("Failed to open PDF page");

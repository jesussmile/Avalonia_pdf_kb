...
public partial class PdfViewerViewModel : ViewModelBase, IDisposable
{
    ...
    public void LoadDocument()
    {
        ...
        _ = loadTask.ContinueWith(t =>
        {
            ...
            {
                Debug.WriteLine($"Thumbnail generation failed: {t.Exception.GetBaseException().Message}");
            }
    ...
    private PageThumbnail CreateThumbnail(int pageNumber)
    {
        lock (_documentLock)
        {
            ...
            var pixelData = _document.Render(pageNumber, bounds, zoom, MuPDFCore.PixelFormats.RGBA);
    ...
    partial void OnActivePageIndexChanged(int value)
    {
        ...
        _renderer.Initialize(_document, threadCount: 0, pageNumber: targetPage);
        _renderer.Cover();
    }

...
- Next steps: implement a true `AndroidPdfPresenter` that wraps `androidx.pdf.widget.PdfView` via `AndroidViewControl`, and an iOS counterpart around `PDFKit`, then register each in their platform heads.